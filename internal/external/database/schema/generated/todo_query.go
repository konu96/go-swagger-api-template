...
import (
	...
	"github.com/Atplaceinc/atplace_api/internal/external/database/schema/generated/predicate"
...
func (tgb *TodoGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("generated: TodoGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TodoGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{todo.Label}
	default:
		err = fmt.Errorf("generated: TodoGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TodoGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("generated: TodoGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TodoGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{todo.Label}
	default:
		err = fmt.Errorf("generated: TodoGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TodoGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("generated: TodoGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TodoGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{todo.Label}
	default:
		err = fmt.Errorf("generated: TodoGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TodoGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("generated: TodoGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TodoGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{todo.Label}
	default:
		err = fmt.Errorf("generated: TodoGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TodoSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("generated: TodoSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TodoSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{todo.Label}
	default:
		err = fmt.Errorf("generated: TodoSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TodoSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("generated: TodoSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TodoSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{todo.Label}
	default:
		err = fmt.Errorf("generated: TodoSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TodoSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("generated: TodoSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TodoSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{todo.Label}
	default:
		err = fmt.Errorf("generated: TodoSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TodoSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("generated: TodoSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TodoSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{todo.Label}
	default:
		err = fmt.Errorf("generated: TodoSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
